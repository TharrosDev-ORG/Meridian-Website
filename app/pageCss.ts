export const indexCss = `
  ...
  .not-list-header::before { content: '\\00d7'; font-family: var(--sans); font-size: 12px; font-weight: 300; color: var(--gold); opacity: 0.7; }
  .not-list li {
  ...
  .not-list li::before { content: '\\00d7'; font-style: normal; font-family: var(--sans); font-size: 11px; font-weight: 300; color: var(--ink-30); flex-shrink: 0; transition: color 0.25s; }
  ...
  @media (max-width: 700px) {
    ...
    .wrap { padding: 0 20px; }
    .about, .who, .not-sec, .speaking, .register { padding: 64px 0; }
    ...
    .stat:nth-child(3), .stat:nth-child(4) { border-top: 1px solid var(--ink-08); }
